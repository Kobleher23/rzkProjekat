...
public class CustomResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<ErrorEntity> handleConflictException(ConflictException ex) {
		ErrorEntity errorEntity = new ErrorEntity(ex.getMessage(), LocalDate.now());
		return new ResponseEntity<>(errorEntity, HttpStatus.CONFLICT);
	}

	@ExceptionHandler(ServisNedostupanException.class)
	public final ResponseEntity<ErrorEntity> handleServisNedostupanException(ServisNedostupanException ex) {
		ErrorEntity errorEntity = new ErrorEntity(ex.getMessage(), LocalDate.now());
		return new ResponseEntity<>(errorEntity, HttpStatus.SERVICE_UNAVAILABLE);
	}
